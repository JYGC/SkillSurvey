...
- [x] **T47** Update unit tests for `buildChartDatasets` — **tests first**
  - File: `tests/unit/services/monthly-count-report.service.spec.ts`
...
- [x] **T48** Update unit tests for `use-monthly-count-report.ts` — **tests first**
  - File: `tests/unit/composables/use-monthly-count-report.spec.ts`
...
- [x] **T49** Update integration test for `MonthlyCountReport.vue` — **tests first**
  - File: `tests/integration/MonthlyCountReport.spec.ts`
...
- [x] **T50** Install `@carbon/charts` and `@carbon/charts-vue`; uninstall `vue-chart-3`
...
- [x] **T51** Update `services/monthly-count-report.service.ts`
...
- [x] **T52** Update `composables/use-monthly-count-report.ts`
...
- [x] **T53** Update `views/public/MonthlyCountReport.vue`
